...
<div class="modal fade bs-example-modal-lg5 in" id="myModal" tabindex="-1" role="dialog"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="input-group date">
                            ...
                            {!! Form::date('data', null , ['class' => 'form-control pull-right', 'id' => '']) !!}
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        {!! Form::label('tipo_ocorrencia', 'Tipo De Ocorrência *') !!}
                        {!! Form::select('tipo_ocorrencia', array_merge([0 => 'Selecione'],\App\Parceiro::ESTADOS_CIVIS), null, ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::label('usuario', 'Usuario Logado *') !!}
