        ...
        $("#campos>#id")
            .append('<div class="row-fluid " id="column-'+ (t + 1) +'"><div class="col-md-12"><hr style="border: 1px solid #ccc"/></div>' +
                        ...
                        '<div class="form-group  col-md-3"><label for="setor">Setor </label>' +
                            '<input type="text" placeholder="Setor ['+ (t + 1) +']" name="extras[' + (t + 1) + '][setor]" class="form-control" />' +
                        '</div>' +
        ...
        $("#idCaminhao")
            .append('<div class="row-fluid " id="caminhao-'+ (parseInt(t) + parseInt(1)) +'"><div class="col-md-12"><hr style="border: 1px solid #ccc"/></div>' +
                ...
                '<div class="form-group  col-md-4"><label for="modelo">Modelo </label>' +
                    '<input type="text" placeholder="Modelo ['+ (parseInt(t) + parseInt(1)) +']" name="extrasCaminhoes[' + (t + 1) + '][modelo]" class="form-control" />' +
                '</div>' +
        ...
        $("#idMotorista")
            .append('<div class="row-fluid " id="motorista-'+ (t + 1) +'"><div class="col-md-12"><hr style="border: 1px solid #ccc"/></div>' +
                ...
                '<div class="form-group  col-md-4">' +
                    ...
                    '<input type="text" placeholder="Rg ['+ (t + 1) +']" name="extrasCaminhoes[' + (t + 1) + '][rg]" class="form-control" />' +
                '</div>' +
                '<div class="form-group  col-md-3">' +
                    '<label for="telefone">Cor </label>' +
                    '<input type="text" placeholder="Telefone" name="extrasCaminhoes[' + (t + 1) + '][telefone]" class="form-control" />' +
                '</div>' +
                '<div class="col-lg-1">' +
                    '<label><hr></label>' +
